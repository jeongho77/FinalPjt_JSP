		...
		<section class="main-list">
			...
			<ul class="comment-list">
				...
				<li style="position: relative;">
					...
					%>
					<button style="width:20px; height: 20px; border: none; position: absolute; transform: translateY(-50%); top: 70%; right: 0%" type="button" onclick="location.href='../com_reply_delete.jsp?number=<%=reply.getNumber()%>&com_num=<%=dto.getNumber()%>'">
